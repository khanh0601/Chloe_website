...
?>
    ...
    <div class="checkout_deli">
      ...
      <div class="checkout_deli_info">
        <div class="checkout_deli_info_title txt_20 ">Địa chỉ nhận hàng</div>
        <div class="checkout_deli_info_form">
          <div class="checkout_deli_info_form_row">
      ...
      <div class="checkout_deli_bank">
        ...
        <div class="checkout_deli_bank_note txt_16">Please fill in the transfer details as follows: <strong>Anna- 0123 456 789</strong></div>
      </div>
      <a href="#" class="menu_cart_button_check">
